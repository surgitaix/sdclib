...
g_apiInterfaces = [
                           ...
                           ['AlertSystemState', 'DescriptorType', 'AlertSystemDescriptor', 'ProviderHandlerType', 'OSCPProviderAlertSystemStateHandler', 'ConsumerHandlerType', 'OSCPConsumerAlertSystemStateHandler'],

...
g_apiInterfaces = [
                           ...
                           ['AlertConditionState', 'DescriptorType', 'AlertConditionDescriptor'],
                           ['AlertSignalState', 'DescriptorType', 'AlertSignalDescriptor'],
                           ['AlertSystemState', 'DescriptorType', 'AlertSystemDescriptor'],
                           ['ClockState', 'DescriptorType', 'ClockDescriptor'],
                           ['EnsembleContextState', 'DescriptorType', 'EnsembleContextDescriptor'],
                           ['EnumStringMetricState', 'DescriptorType', 'EnumStringMetricDescriptor'],
                           ['MdsState', 'DescriptorType', 'MdsDescriptor'],
                           ['LimitAlertConditionState', 'DescriptorType', 'LimitAlertConditionDescriptor'],
                           ['LocationContextState', 'DescriptorType', 'LocationContextDescriptor'],
                           ['NumericMetricState', 'DescriptorType', 'NumericMetricDescriptor'],
                           ['OperatorContextState', 'DescriptorType', 'OperatorContextDescriptor'],
                           ['RealTimeSampleArrayMetricState', 'DescriptorType', 'RealTimeSampleArrayMetricDescriptor'],
                           ['StringMetricState', 'DescriptorType', 'StringMetricDescriptor'],

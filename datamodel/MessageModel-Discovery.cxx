  ...
  namespace MESSAGEMODEL
  {
    namespace DISCOVERY
    {
                 ...
                 const ::xml_schema::Properties& p)
      {
        ...
        return ::std::unique_ptr< ::WS::MESSAGEMODEL::DISCOVERY::Envelope > (
          ::WS::MESSAGEMODEL::DISCOVERY::Envelope_ (
                 ...
                 const ::xml_schema::Properties& p)
      {
        ...
        return ::WS::MESSAGEMODEL::DISCOVERY::Envelope_ (isrc, f, p);
      }
                 ...
                 const ::xml_schema::Properties& p)
      {
        ...
        ::xsd::cxx::xml::sax::std_input_source isrc (is);
        return ::WS::MESSAGEMODEL::DISCOVERY::Envelope_ (isrc, h, f, p);
      }
                 ...
                 const ::xml_schema::Properties& p)
      {
        ...
        {
          ::std::unique_ptr< ::WS::MESSAGEMODEL::DISCOVERY::Envelope > r (
            ::xsd::cxx::tree::traits< ::WS::MESSAGEMODEL::DISCOVERY::Envelope, char >::create (
              e, f, 0));
          return r;
        }
  ...
  namespace MESSAGEMODEL
  {
    namespace DISCOVERY
    {
      ...
      Envelope_ (::std::ostream& o,
                 const ::WS::MESSAGEMODEL::DISCOVERY::Envelope& s,
                 ...
                 ::xml_schema::Flags f)
      {
        ...
        ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
          ::WS::MESSAGEMODEL::DISCOVERY::Envelope_ (s, m, f));
      ...
      Envelope_ (const ::WS::MESSAGEMODEL::DISCOVERY::Envelope& s,
                 const ::xml_schema::NamespaceInfomap& m,
                 ::xml_schema::Flags f)
      {
        ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
        ...
        ::WS::MESSAGEMODEL::DISCOVERY::Envelope_ (*d, s, f);
        return d;
      }

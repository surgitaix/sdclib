...
namespace WS
{
  namespace WSDL
  {
    ...
    parseDefinitions (const ::std::string& u,
                      ::xml_schema::Flags f,
                      ...
                      const ::xml_schema::Properties& p)
    {
      ...
      return ::WS::WSDL::parseDefinitions (isrc, f, p);
    }
                      ...
                      const ::xml_schema::Properties& p)
    {
      ...
      ::xsd::cxx::xml::sax::std_input_source isrc (is);
      return ::WS::WSDL::parseDefinitions (isrc, h, f, p);
    }
    ...
    ::std::unique_ptr< ::WS::WSDL::TDefinitions >
    parseDefinitions (::xercesc::InputSource& i,
                      ::xml_schema::Flags f,
                      const ::xml_schema::Properties& p)
    {
      ::xsd::cxx::tree::error_handler< char > h;
    ...
    ::std::unique_ptr< ::WS::WSDL::TDefinitions >
    parseDefinitions (const ::xercesc::DOMDocument& doc,
                      ::xml_schema::Flags f,
                      const ::xml_schema::Properties& p)
    {
...
namespace WS
{
  namespace WSDL
  {
    ...
    void
    serializeDefinitions (::std::ostream& o,
                          ...
                          ::xml_schema::Flags f)
    {
      ...
      ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
        ::WS::WSDL::serializeDefinitions (s, m, f));
    ...
    void
    serializeDefinitions (::xercesc::XMLFormatTarget& t,
                          const ::WS::WSDL::TDefinitions& s,
                          const ::xml_schema::NamespaceInfomap& m,
                          const ::std::string& e,
                          ::xml_schema::Flags f)
    ...
    serializeDefinitions (const ::WS::WSDL::TDefinitions& s,
                          const ::xml_schema::NamespaceInfomap& m,
                          ::xml_schema::Flags f)
    {
      ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d;
      ...
      ::WS::WSDL::serializeDefinitions (*d, s, f);
      return d;
    }

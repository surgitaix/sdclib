...
#ifndef BICEPS_PARTICIPANT_MODEL_FWD_HXX
#define BICEPS_PARTICIPANT_MODEL_FWD_HXX
...
namespace CDM
{
  ...
  class AlertConditionMonitoredLimits;
  class LimitAlertConditionState;
  class AlertSignalManifestation;
  class AlertSignalDescriptor;
  class AlertSignalPresence;
  class AlertSignalPrimaryLocation;
...
#endif // BICEPS_PARTICIPANT_MODEL_FWD_HXX

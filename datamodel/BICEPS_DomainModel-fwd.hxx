...
#ifndef BICEPS_DOMAIN_MODEL_FWD_HXX
#define BICEPS_DOMAIN_MODEL_FWD_HXX
...
namespace CDM
{
  ...
  class SystemContext;
  class AbstractDeviceComponent;
  class AbstractMDSDescriptor;
  class HydraMDSDescriptor;
  class ComponentState;
  class AbstractMDSState;
  class HydraMDSState;
  class AlertConditionKind;
  class AlertConditionPriority;
  class AlertSignalManifestation;
  ...
  class PausableActivation;
  class SignalPresence;
  class PrimaryAlertSignalLocation;
  class MonitoredAlertLimits;
  ...
  class MetricMeasurementValidity;
  ...
  class NonGenericOperationDescriptor;
  ...
  class AbstractIdentifiableContextState;
...
#endif // BICEPS_DOMAIN_MODEL_FWD_HXX

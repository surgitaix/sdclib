...
std::vector<CodedValue> WorkflowDetail::getDangerCodes() const {
...
void WorkflowDetail::clearDangerCodes() {
...
std::vector<ClinicalInfo> WorkflowDetail::getRelevantClinicalInfos() const {
...
void WorkflowDetail::clearRelevantClinicalInfos() {

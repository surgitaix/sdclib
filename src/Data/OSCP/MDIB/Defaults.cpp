...
CDM::LocalizedText  * Defaults::LocalizedText() {
	return new CDM::LocalizedText("Text not assigned.");
}
...
CDM::Measurement  * Defaults::Measurement() {
	return new CDM::Measurement(ConvertToCDM::convert(OSCP::CodedValue()), 0);
}

CDM::ProductionSpecification  * Defaults::ProductionSpecification() {
	return new CDM::ProductionSpecification(ConvertToCDM::convert(OSCP::CodedValue()), "not assigned");
}
...
CDM::AlertConditionDescriptor  * Defaults::AlertConditionDescriptor() {
	return new CDM::AlertConditionDescriptor(NOT_ASSIGNED, NOT_ASSIGNED, NOT_ASSIGNED);
}
...
CDM::MetricQuality  * Defaults::MetricQuality() {
	return new CDM::MetricQuality(NOT_ASSIGNED);
}

CDM::Annotation  * Defaults::Annotation() {
	return new CDM::Annotation(NOT_ASSIGNED);
}

CDM::NumericMetricValue  * Defaults::NumericMetricValue() {
	return new CDM::NumericMetricValue(NOT_ASSIGNED);
}

CDM::StringMetricValue  * Defaults::StringMetricValue() {
	return new CDM::StringMetricValue(NOT_ASSIGNED);
}

CDM::SampleArrayValue  * Defaults::SampleArrayValue() {
	return new CDM::SampleArrayValue(NOT_ASSIGNED);
}

CDM::ApplyAnnotation  * Defaults::ApplyAnnotation() {
	return new CDM::ApplyAnnotation(NOT_ASSIGNED);
}
...
CDM::Argument  * Defaults::Argument() {
	return new CDM::Argument(NOT_ASSIGNED);
}
...
CDM::RelatedMeasurement  * Defaults::RelatedMeasurement() {
	return new CDM::RelatedMeasurement(NOT_ASSIGNED);
}

CDM::ReferenceRange  * Defaults::ReferenceRange() {
	return new CDM::ReferenceRange(NOT_ASSIGNED);
}

CDM::ImagingProcedure  * Defaults::ImagingProcedure() {
	return new CDM::ImagingProcedure(NOT_ASSIGNED);
}
...
CDM::WorkflowDetail  * Defaults::WorkflowDetail() {
	return new CDM::WorkflowDetail(NOT_ASSIGNED);
}

CDM::RequestedOrderDetail  * Defaults::RequestedOrderDetail() {
	return new CDM::RequestedOrderDetail(NOT_ASSIGNED);
}

CDM::PerformedOrderDetail  * Defaults::PerformedOrderDetail() {
	return new CDM::PerformedOrderDetail(NOT_ASSIGNED);
}

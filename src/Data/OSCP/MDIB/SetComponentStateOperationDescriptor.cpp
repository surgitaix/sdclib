...
std::vector<std::string> SetComponentStateOperationDescriptor::getModifiableElements() const {
...
void SetComponentStateOperationDescriptor::clearModifiableElements() {

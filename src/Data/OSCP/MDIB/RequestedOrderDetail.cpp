...
RequestedOrderDetail & RequestedOrderDetail::setStart(const DateTime & value) {
	data->Start(ConvertToCDM::convert(value));
	return *this;
}

bool RequestedOrderDetail::getStart(DateTime & out) const {
...
DateTime RequestedOrderDetail::getStart() const {
...
RequestedOrderDetail & RequestedOrderDetail::setEnd(const DateTime & value) {
	data->End(ConvertToCDM::convert(value));
	return *this;
}

bool RequestedOrderDetail::getEnd(DateTime & out) const {
	if (data->End().present()) {
...
DateTime RequestedOrderDetail::getEnd() const {
...
std::vector<PersonParticipation> RequestedOrderDetail::getPerformers() const {
...
void RequestedOrderDetail::clearPerformers() {
...
std::vector<CodedValue> RequestedOrderDetail::getServices() const {
...
void RequestedOrderDetail::clearServices() {
	data->Service().clear();
}
...
std::vector<ImagingProcedure> RequestedOrderDetail::getImagingProcedures() const {
...
void RequestedOrderDetail::clearImagingProcedures() {

...
/*
 * OSCPConsumerStringMetricStateHandler.h
 *
...
public:
    ...
    */
    virtual void onStateChanged(const StringMetricState & state) = 0;
};
...
#endif /* INCLUDE_OSCLIB_DATA_OSCP_OSCPCONSUMERSTRINGMETRICSTATEHANDLER_H_ */

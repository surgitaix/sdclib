...
public:
	...
	static InvocationError convert(const CDM::InvocationError & source);
	static DescriptionModificationType convert(const CDM::DescriptionModificationType & source);
	static RetrievabilityMethod convert(const CDM::RetrievabilityMethod & source);
	...
	static InvocationInfo convert(const CDM::InvocationInfo & source);
	static AbstractGet convert(const CDM::AbstractGet & source);
	static AbstractGetResponse convert(const CDM::AbstractGetResponse & source);
	static AbstractReportPart convert(const CDM::AbstractReportPart & source);
	static AbstractReport convert(const CDM::AbstractReport & source);
	static AbstractSet convert(const CDM::AbstractSet & source);
	static AbstractSetResponse convert(const CDM::AbstractSetResponse & source);
	static AbstractContextReport convert(const CDM::AbstractContextReport & source);
	static VersionFrame convert(const CDM::VersionFrame & source);
	static TimeFrame convert(const CDM::TimeFrame & source);
	static AbstractMetricReport convert(const CDM::AbstractMetricReport & source);
	static AbstractComponentReport convert(const CDM::AbstractComponentReport & source);
	static AbstractAlertReport convert(const CDM::AbstractAlertReport & source);
	static AbstractOperationalStateReport convert(const CDM::AbstractOperationalStateReport & source);
	static RetrievabilityInfo convert(const CDM::RetrievabilityInfo & source);
	...
	static ExtensionType convert(const CDM::ExtensionType & source);
};

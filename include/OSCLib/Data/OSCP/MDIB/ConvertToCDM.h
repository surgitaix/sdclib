...
public:
	...
	static CDM::InvocationError convert(const InvocationError & source);
	static CDM::DescriptionModificationType convert(const DescriptionModificationType & source);
	static CDM::RetrievabilityMethod convert(const RetrievabilityMethod & source);

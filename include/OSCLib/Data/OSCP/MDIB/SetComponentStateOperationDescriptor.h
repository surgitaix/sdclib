...
public:
	...
	SetComponentStateOperationDescriptor & setHandle(const std::string & value);
	...
	SetComponentStateOperationDescriptor & setOperationTarget(const std::string & value);
	std::string getOperationTarget() const;

	SetComponentStateOperationDescriptor & addModifiableElement(const std::string & value);

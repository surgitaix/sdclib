...
const static std::string SCHEMA_BICEPS_MESSAGEMODEL_CONTENT = std::string(R"(<?xml version="1.0"?>
<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:ext="http://standards.ieee.org/downloads/11073/11073-10207-2017/extension" xmlns:pm="http://standards.ieee.org/downloads/11073/11073-10207-2017/participant" xmlns:msg="http://standards.ieee.org/downloads/11073/11073-10207-2017/message" targetNamespace="http://standards.ieee.org/downloads/11073/11073-10207-2017/message" elementFormDefault="qualified" attributeFormDefault="unqualified" xml:lang="en">
	...
	<xsd:complexType name="InvocationInfo">
		...
		<xsd:sequence>
			...
			<xs)"
R"(d:element name="InvocationState" type="msg:InvocationState">
	...
	<xsd:element name="GetMdibResponse">
		...
		<xsd:complexType>
			<xsd:complexContent>
				<xsd:extension base="msg:AbstractGetRes)"
R"(ponse">
					<xsd:sequence>
		...
		<xsd:complexType>
			<xsd:complexContent>
				<xsd:extension base="msg:AbstractGetResponse">
					<xsd:sequence>
						<xs)"
R"(d:element name="ContextState" type="pm:AbstractContextState" minOccurs="0" maxOccurs="unbounded">
...
R"(plexType>
	...
	<xsd:complexType name="VersionFrame">
		...
		<xsd:attribute name="End" type="pm:ReferencedVersi)"
R"(on">
					...
					<xsd:element name="ReportPart" minOccurs="0" maxOccurs="unbounded">
						...
						<xsd:complexType>
							<xsd:complexContent>
								<xsd:extension base="msg:AbstractReportPart">
									<xsd:sequence>
										<xsd:element name="ComponentState" type="pm:AbstractDeviceComponentState" m)"
R"(inOccurs="0" maxOccurs="unbounded">
	...
	<xsd:complexType name="AbstractOperationalStateReport">
		...
		<xsd:complexContent>
			<xsd:extension base="msg:AbstractReport">
				<xsd:sequence>
					<xsd:element name="ReportPart" minOcc)"
R"(urs="0" maxOccurs="unbounded">
					...
					<xsd:sequence>
						<xsd:element name="Value" minOccurs="0" maxOccurs="unbounded">
							<xsd:complexType>
								...
								<xsd:sequence>
									<xsd:element name="Value" type="pm:S)"
R"(ampleArrayValue" minOccurs="0" maxOccurs="1"/>
								</xsd:sequence>

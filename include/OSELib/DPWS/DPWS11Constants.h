...
namespace OSELib
{
    ...
    const std::string WS_ACTION_SUBSCRIPTIONEND("http://schemas.xmlsoap.org/ws/2004/08/eventing/SubscriptionEnd");
    const std::string WS_ACTION_SUBSCRIPTIONEND_RESPONSE("http://schemas.xmlsoap.org/ws/2004/08/eventing/SubscriptionEndResponse");
    ...
    const std::string WS_EVENTING_DELIVERYMODE_PUSH("http://schemas.xmlsoap.org/ws/2004/08/eventing/DeliveryModes/Push");
    const std::string WS_EVENTING_FILTER_ACTION("http://docs.oasis-open.org/ws-dd/ns/dpws/2009/01/Action");

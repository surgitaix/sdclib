...
const std::string EVENT_ACTION_CDM_EPISODIC_COMPONENT_REPORT(NS_SERVICE_DESCRIPTION + "/" + QNAME_STATEEVENTREPORTSERVICE_PORTTYPE + "/EpisodicComponentReport");
const std::string EVENT_ACTION_CDM_PERIODIC_COMPONENT_REPORT(NS_SERVICE_DESCRIPTION + "/" + QNAME_STATEEVENTREPORTSERVICE_PORTTYPE + "/PeriodicComponentReport");
const std::string EVENT_ACTION_CDM_EPISODIC_CONTEXT_REPORT(NS_SERVICE_DESCRIPTION + "/" + QNAME_CONTEXTSERVICE_PORTTYPE + "/EpisodicContextReport");
const std::string EVENT_ACTION_CDM_PERIODIC_CONTEXT_REPORT(NS_SERVICE_DESCRIPTION + "/" + QNAME_CONTEXTSERVICE_PORTTYPE + "/PeriodicContextReport");
...
const std::string EVENT_ACTION_CDM_EPISODIC_OPERATIONALSTATE_REPORT(NS_SERVICE_DESCRIPTION + "/" + QNAME_STATEEVENTREPORTSERVICE_PORTTYPE + "/EpisodicOperationalStateReport");
const std::string EVENT_ACTION_CDM_PERIODIC_OPERATIONALSTATE_REPORT(NS_SERVICE_DESCRIPTION + "/" + QNAME_STATEEVENTREPORTSERVICE_PORTTYPE + "/PeriodicOperationalStateReport");
...
const std::string UUID_SDC_BASE_NAMESPACE("72772F61-0266-49F9-9552-393C1857B269"); // IEEE 11073 - 20701 - Annex A
